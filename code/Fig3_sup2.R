...
# assemble figure ---------------------------------------------------------
panel_MLD <- ggdraw() + draw_image(readPNG("pictures/HCR_51_DV_NITGC1_MLD_DAPI_112.55µm.png"))+
...
Fig3_sup2 <- panel_MLD + panel_NIT2 + panel_cop1 + panel_NIT2_cop1 +
  patchwork::plot_layout(design = layout, widths = c(1,0.01, 1,0.01, 1,0.01, 1)) + #we can change the heights of the rows in our layout (widths also can be defined)
...
ggsave("figures/Fig3_sup2.png", limitsize = FALSE, 
       units = c("px"), Fig3_sup2, width = 2400, height = 750, bg='white') 
