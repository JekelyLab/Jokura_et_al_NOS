function fit_uv_av_inrgw(p_fixed,to_fit,init_par,npars_est,n_var,file_prefix)

npop = 1000;
paramstoest = 1:npars_est;

uv_av_opt = @(x) uv_av_mobj_inrgw(x,p_fixed,n_var,to_fit);
