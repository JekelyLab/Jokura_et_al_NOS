...
best_vals=[0.4639    0.0528    1.8346    0.7406...
           0.2621    0.6036 ...
           0.1360    0.5933 ...
...
for i=1:11
    ...
    if i<7
        ...
        hold on
        plot([0.75 2.25],[best_vals(disp_ord(i)) best_vals(disp_ord(i))],'--','linewidth',3,'Color',[0.25 0.25 0.25])
...
best_vals=[34.9330    0.2934    2.9941    1.8258...
...
for i=1:14
    ...
    violin_structure(1).ViolinColor=[0.72 0.27 1];
    hold on
    plot([0.75 1.25],[best_vals(idx_sort(i)) best_vals(idx_sort(i))],'--','linewidth',3,'Color',[0.25 0.25 0.25])
