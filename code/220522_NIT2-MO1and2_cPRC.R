...
MO <- read_csv("data/220522_NIT2-MO1and2.csv")


#Selection
MO1_cPRC <- MO %>% select(frame, starts_with("NIT2-MO1"))
...
#Selection
MO2_cPRC <- MO %>% select(frame, starts_with("NIT2-MO2"))
...
#Save
ggsave("NIT2_MO1.png", plot = MO1_graph, path = "pictures", dpi = 400, bg = "white")
ggsave("NIT2_MO2.png", plot = MO2_graph, path = "pictures", dpi = 400, bg = "white")
